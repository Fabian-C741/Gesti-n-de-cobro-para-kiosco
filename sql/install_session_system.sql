-- SCRIPT COMPLETO PARA CONFIGURAR SESIONES POR ROL
-- Ejecutar este archivo completo para instalar todo el sistema
...
SELECT 'Configuración de sesiones instalada correctamente' as status;
SELECT * FROM configuracion_sesiones;
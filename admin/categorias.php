    ...
    if (!verify_csrf_token($_POST['csrf_token'] ?? '')) {
        ...
        if ($action === 'crear') {
            ...
            try {
                ...
                log_activity($db, $_SESSION['user_id'], 'editar_categoria', "Categoría ID: $id");
            ...
            if ($count > 0) {
                ...
                log_activity($db, $_SESSION['user_id'], 'eliminar_categoria', "Categoría ID: $id");
            ...
            log_activity($db, $_SESSION['user_id'], 'activar_categoria', "Categoría ID: $id");
            ...
            <form method="POST" id="formCategoria">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="descripcion" id="categoriaDescripcion" rows="3"></textarea>
                    </div>
                </div>
